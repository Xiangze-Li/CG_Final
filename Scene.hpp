...
namespace TEXTURE
{
    ...
    Texture t(Vec3(0.999), Texture::Reflect_t::SPEC);
    Texture t_m(Vec3(0.5), Texture::Reflect_t::SPEC);
    Texture t1(Vec3(0.99), Texture::Reflect_t::DIFF);
    Texture t2(Vec3(0.999), Texture::Reflect_t::REFR, 1.1);
...
SceneParser dinosaur2(
    ...
    {new Mesh("obj_models/dinosaur.2k.obj", Vec3(50, 50, 50), 0.75, &(TEXTURE::t2)),
     new Plane(Vec3(0, 0, 1), 0, &(TEXTURE::textures[2])),
     new Plane(Vec3(0, 0, -1), 100, &(TEXTURE::t_w)),
     new Plane(Vec3(0, -1, 0), 100, &(TEXTURE::t)),
     new Plane(Vec3(0, 1, 0), 0, &(TEXTURE::t_w)),
     new Plane(Vec3(1, 0, 0), 100, &(TEXTURE::t_w)),
     new Plane(Vec3(-1, 0, 0), 0, &(TEXTURE::textures[4])),
     new Sphere(Vec3(20, 10, 30), 20, &(TEXTURE::t2)),
     new Sphere(Vec3(80, 80, 80), 15, &(TEXTURE::t_m))},
    Vec3(0.));

SceneParser spheres(
    "spheres",
    Camera(Vec3(50, 50, 100), Vec3(0, 0, -1), Vec3(0, 1, 0), 90.0, 720, 720, 0.),
    ...
    {new Plane(Vec3(0, 1, 0), 0., &(TEXTURE::textures[1])),
     ...
     new Sphere(Vec3(30, 70, 30), 20., &TEXTURE::t_m)},
    Vec3(0.));
